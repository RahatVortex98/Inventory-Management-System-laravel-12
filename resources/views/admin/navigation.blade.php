        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.categoryList')" :active="request()->routeIs('admin.categoryList')">
                        {{ __('Categories') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.supplierList')" :active="request()->routeIs('admin.supplierList')">
                        {{ __('Suppliers') }}
                    </x-nav-link>
